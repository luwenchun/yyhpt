...
<head>
    ...
    <script src="yyhpt/pages/jhgl/fwjhzxList.js" type="text/javascript"></script>
    <style type="text/css">
        .radio-container {
            padding-left: 8px;
        }
...
<%--<div class="panel panel-default">
    <div class="panel-body nopadding" style="padding-top: 10px;">
        <div class="form-group list-space-row">
            <div class=" col-md-6 col-xs-12" margin-bottom: 6px;>
                <div class="col-md-2 col-xs-3 nopadding" style="text-align:right;left: 12px;">
                    <label class="control-label">姓名：</label>
                </div>
                <p id="hzxm" class="control-label col-md-2 col-xs-8 nopadding"
                   style="text-align: left;color: #434343;padding-left: 10px;margin-bottom: 6px;"></p>

                <div class="col-md-4 col-xs-4 nopadding" style="text-align:center;">
                    <label class="control-label nopadding">联系电话：</label>
                </div>
                <p id="lxdh" class="col-md-4 col-xs-8 nopadding control-label" style="color: #434343;"></p>
            </div>
            <div class=" col-md-6 col-xs-12" style="margin-bottom: 6px;">
                <div class="col-md-3 col-xs-4" style="left: 10px;">
                    <label class="control-label">执行人：</label>
                </div>
                <p id="jhzxryxm" class="col-md-2 col-xs-6 nopadding control-label"
                   style="color: #434343;right: 6px;margin-bottom: 6px;">${ryxm}</p>

                <div class="col-md-3 col-xs-5" style="text-align: center;padding-left: 0px;padding-right: 20px;">
                    <label class="control-label">执行日期：</label>
                </div>
                <p id="jhzxrq" class="col-md-4 col-xs-6 nopadding control-label"
                   style="color: #434343;right: 30px;margin-bottom: 6px;"></p>
            </div>
        </div>
        <div class="form-group list-space-row" id="cqjh_type" style="padding-left: 15px;display: block;">

            <div class="col-md-1 col-xs-3 nopadding" style="text-align:right;left: 10px;">
                <label class="control-label">评估结论：</label>
            </div>
            <p id="pgjlnrgr" class="nopadding col-md-1 col-xs-9 control-label"
               style="text-align: left;color: #434343;margin-bottom: 6px;left: 12px;"></p>

            <div class="col-md-1 col-xs-3 nopadding" style="text-align:right;left: 24px;">
                <label class="control-label nopadding">服务频次：</label>
            </div>
            <p id="jhzdfwpc" class="col-md-2 col-xs-9 nopadding control-label"
               style="text-align: left;color: #434343;margin-bottom: 6px;left: 24px;"></p>
            <div class="col-md-2 col-xs-4" style="text-align: right;padding-left: 0px;padding-right: 0px;left: 17px;">
                <label class="control-label">服务时间：</label>
            </div>
            <p id="jhzdzxsj" class="col-md-4 col-xs-8 nopadding control-label"
               style="color: #434343;right: 66px;padding-left: 96px;border-left-width: 60px;"></p>
        </div>
        ...
        <div class="form-group list-space-row" id="lsjh_type" style="padding-left: 15px;display: none;">
            ...
            <p id="pgjlnrgr_lsjh" class="nopadding col-md-1 col-xs-9 control-label"
               style="text-align: left;color: #434343;margin-bottom: 6px;left: 8px;"></p>
...
<div class="panel panel-default">
    <div class="panel-body nopadding" style="padding-top: 10px;">
        ...
        <div class="form-group list-space-row" id="lsjh_type" style="padding-left: 15px;display: none;">
            ...
            <p id="jhzdzxsj_lsjh" class="col-md-5 col-xs-9 nopadding control-label"
               style="text-align: left;color: #434343;"></p>
        </div>
