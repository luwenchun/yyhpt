            ...
            <div class="panel-body toolbar " style="margin-top: 5px;">
                <div class="form-group">
                    <div class="pull-left">
                        <div class="input-group  input-group-sm" style="width: 200px;">
                            <input type="text" class="form-control input-sm" id="qrymc"
                                   placeholder="管理分类"><span class="input-group-btn">
                    ...
                    <div class="pull-right ">
                        <button id="add" type="button" class="btn btn-default btn-sm">新增管理分类</button>
                    </div>
                </div>
            </div>
        </form>
...
<script src="yyhpt/pages/jcsj/glflList.js" type="text/javascript"></script>
</body>
</html>