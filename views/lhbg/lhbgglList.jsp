...
<div class="panel-body">
    <div class="panel panel-default">
        <div class="panel-heading" style="font-size:16px;color:#434343;font-weight:bold;">
            <span class="glyphicon glyphicon-th"></span> 轮候变更列表
        </div>
        <div class="form-group" style="margin:10px 0px 10px 0px;">
            ...
            <div class="pull-right list-btnDiv" id="jhbgglList_btn">
                <button class="btn btn-default btn-sm" id="btn_add" type="button" style="margin-bottom: 5px;">
                    新增
                </button>
                <button id="btn_query" class="btn btn-default btn-sm" style="margin-bottom: 5px;">
                    查询
                </button>
                <button id="export" class="btn btn-default btn-sm" style="margin-bottom: 5px;">
                    导出
                </button>
        ...
        <table id="lhbgglTable" class="table-container"></table>
    </div>
</div>

<script src="${basePath}/yyhpt/pages/lhbg/lhbgglList.js" type="text/javascript"></script>
</body>
</html>