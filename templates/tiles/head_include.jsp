...
<link rel="stylesheet"
      href="${basePath}/frame/css/skins/skin-white.css"><%--
<link rel="stylesheet"
...
<link rel="stylesheet"
      href="${basePath}/layouts/css/custom.css">
...
<link rel="shortcut icon" href="${basePath}/frame/img/favicon.ico"
      type="image/x-icon"/>
<link href="${basePath}/frame/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.css" rel="stylesheet"/>
...
<script src="${basePath}/layouts/scripts/app.js"
        type="text/javascript"></script>
<script src="${basePath}/frame/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"
        type="text/javascript"></script>
<script src="${basePath}/frame/plugins/bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js"
        type="text/javascript" charset="utf-8"></script>

<script src="${basePath}/frame/scripts/wnform-extra.js"
        type="text/javascript"></script>
<script src="frame/plugins/when/dist/browser/when.min.js"></script>

<script src="layouts/scripts/app.differ.js"></script>
