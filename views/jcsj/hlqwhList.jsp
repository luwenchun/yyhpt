			...
			<div class="panel-body toolbar" style="margin-top: 5px;">
				<div class="form-group">
					<div class="pull-left">
						<div class="input-group  input-group-sm" style="width: 200px;">
							<input type="text" class="form-control input-sm" id="qrymc"
								placeholder="护理券"> <span class="input-group-btn">
					...
					<div class="pull-right ">
						<button id="add" type="button" class="btn btn-default btn-sm">新增护理券</button>
					</div>
				</div>
			</div>
		</form>
...
<script src="yyhpt/pages/jcsj/hlqwhList.js" type="text/javascript"></script>
</body>
</html>