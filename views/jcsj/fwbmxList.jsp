			...
			<div class="panel-body toolbar" style="margin-top: 5px;">
				<div class="form-group">
					<div class="pull-left">
						<div class="input-group  input-group-sm" style="width: 200px;">
							<input type="text" class="form-control input-sm" id="qrymc"
								placeholder="服务包明细"> <span class="input-group-btn">
					...
					<div class="pull-right ">
						<button id="add" class="btn btn-default btn-sm">新增服务包明细</button>
...
<script src="yyhpt/pages/jcsj/fwbmxList.js" type="text/javascript"></script>
</body>
</html>