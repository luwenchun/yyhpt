                ...
                <div class="form-group">
                    <div class="pull-left">
                        <div class="input-group input-group-sm" style="width: 200px;">
                            <input type="text" class="form-control input-sm" id="mc" placeholder="优惠策略名称"/>
                    ...
                    <div class="pull-right">
                        <button id="add" type="button" class="btn btn-default btn-sm">新增优惠策略</button>
                    </div>
                </div>
            </div>
        </form>
...
<script src="yyhpt/pages/jcsj/yhpzList.js" type="text/javascript"></script>
</body>
</html>
