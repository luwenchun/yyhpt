                ...
                <div class="form-group">
                    <div class="pull-left">
                        <div class="input-group  input-group-sm" style="width: 230px">
                            <input type="text" class="form-control input-sm" id="tcmcQuery" placeholder="服务包名称">
                    ...
                    <div class="pull-right ">
                        <button id="add" type="button" class="btn btn-default btn-sm">新增服务包</button>
                    </div>
                </div>
            </div>
        </form>
...
<script src="yyhpt/pages/jcsj/fwbList.js" type="text/javascript"></script>
</body>
</html>