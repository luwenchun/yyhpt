			...
			<div class="panel-body toolbar" style="margin-top: 5px;">
				<div class="form-group">
					<div class="pull-left">
						<div class="input-group  input-group-sm" style="width: 200px;">
							<input type="text" class="form-control input-sm" id="qrymc"
								placeholder="存储过程名称"> <span class="input-group-btn">
					...
					<div class="pull-right ">
						<button id="add" type="button" class="btn btn-default btn-sm">新增存储过程</button>
						<button id="mobile" type="button" class="btn btn-default btn-sm hidden">手机模式</button>
					</div>
				</div>
			</div>
		</form>
...
<script src="yyhpt/pages/jcsj/ccgcList.js" type="text/javascript"></script>
</html>