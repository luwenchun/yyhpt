			...
			<div class="panel-body toolbar" style="margin-top: 5px;">
				<div class="form-group">
					<div class="pull-left">
						<div class="input-group  input-group-sm" style="width: 200px;">
							<input type="text" class="form-control input-sm" id="qrymc"
								placeholder="业务项目名称"> <span class="input-group-btn">
					...
					<div class="pull-right">
						<button id="add" type="button" class="btn btn-default btn-sm">新增业务项目</button>
					</div>
				</div>
			</div>
		</form>
...
<script src="yyhpt/pages/jcsj/ywxmList.js" type="text/javascript"></script>
</body>
</html>