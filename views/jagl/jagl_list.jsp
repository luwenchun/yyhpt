...
<div class="panel-body">
    <div class="panel panel-default">
        <div class="panel-heading" style="font-size:16px;color:#434343;font-weight:bold;">
            <span class="glyphicon glyphicon-th"></span> 结案管理列表
        </div>
...
//            pauseApply();
        ...
        table.bootstrapTable(
                {
                    ...
                    url: "yyhpt_jagl.do?action=get_list", // 获取数据的Servlet地址
                    ...
                    columns: [
...

                        {
                            ...
                            formatter: function (value, row, index) {
                                return '<a class="edit_info" href="javascript:void(0)"><img src="layouts/img/table/icon_right.png"> ' + value + '</a>';
                            }
                        }, {
                            field: 'shrq',
                            title: '结案审核',
                            ...
                            formatter: function (value, row, index) {
                                ...
                                if (value) {
                                    ...
                                    return '<a class="info_review" href="javascript:void(0)"  > <img src="layouts/img/table/icon_del.png"> 审核<a/>';
                                }
                            }
                        }, {
                            title: '操作',
    ...
    function pauseApply() {
        BootstrapDialog.show({
            ...
            message: $('<div></div>').load('yyhpt/views/jagl/jasq_detail.jsp'),
            buttons: [{
                id: 'id_apply_save',
                label: '保存',
    ...
    function pauseReview() {
        BootstrapDialog.show({
            ...
            closeByBackdrop: false,
            closeByKeyboard: false,
            message: $('<div></div>').load('yyhpt/views/jagl/jash_detail.jsp'),
            buttons: [{
                id: 'id_review_save',
                label: '保存',
                cssClass: 'btn-default btn-sm',
    ...
    function deleteApply(row) {
        ...
        $.getJSON('yyhpt_jagl.do?action=do_delete', {jalsh: row.jalsh}, function (data) {
