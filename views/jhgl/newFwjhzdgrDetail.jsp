...
<head>
    ...
    <script src="yyhpt/pages/jhgl/newFwjhzdgrDetail.js" type="text/javascript"></script>
    <script>
    ...
    <div class="panel-body nopadding" style="padding-top: 10px;">
        ...
        <div class="col-md-12 col-xs-12" id="cqjh_fwsj" style="padding-left: 15px;display: block;padding-right: 0px;">
            <label class="control-label col-md-1 col-xs-12"
                   style="padding-left: 0px;padding-right: 0px;color:#737373;font-size:14px">服务时间：</label>
        ...
        <div class="col-md-12 col-xs-12">
            <div style="margin: 0px 30px 0px 0px; background-color: #F7F7F7;">
                <div class="form-group nopadding" style="margin: 8px 12px">
                    ...
                    <div id="fileDiv" class="col-md-10 col-sm-10">&nbsp;
                        <div id="fjdzDiv" class="fileinput fileinput-new" data-provides="fileinput"><span
                                class="btn btn-default btn-sm btn-file">	<span class="fileinput-new"> 选取文件 </span>	<span
