...
function loadfwjhzdDetail(row, title, value) {
    ...
    BootstrapDialog.show({
        ...
        message: $('<div></div>').load('yyhpt/views/jhgl/newFwjhzdgrDetail.jsp'),
...
function selectfwjhshList(row, title, value) {
    ...
    if (row.JHLSH == '' || row.JHLSH == null) {
        ...
        BootstrapDialog.show({
            ...
            closeByBackdrop: false,
            closeByKeyboard: false,
            message: $('<div></div>').load('yyhpt/views/jhgl/fwjhshList.jsp'),
            onshow: function (dialogRef) {
...
function selectfwjhzxList(row, title, value) {
    ...
    if (row.JHLSH == '' || row.JHLSH == null) {
        ...
        BootstrapDialog.show({
            ...
            closeByBackdrop: false,
            closeByKeyboard: false,
            message: $('<div></div>').load('yyhpt/views/jhgl/fwjhzxList.jsp'),
            onshow: function (dialogRef) {
