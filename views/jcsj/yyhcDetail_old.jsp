...
<head>
    ...
    <script type="text/javascript" src="yyhpt/pages/jcsj/yyhcDetail_old.js"/>
...
<form id="defaultForm" method="post" class="form-horizontal">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-md-1 col-xs-3 control-label">
                    规格：
                </label>
                <div class="form-group col-md-11 col-xs-10" id="ggform">
                    <input type="text" name="GG" id="GG"/>
                    <div class="form-group col-md-6 col-xs-12" id="gg-0">
                        ...
                        <div class="col-md-1" style="padding-top: 6px;">
                            <a class="plus" href="javascript:void(0)" data-toggle="modal" disabled title="增加">
