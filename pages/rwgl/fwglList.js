...
//弹出二级页面-服务登记
modelFunc = function (showOrHide, row, mtitle, mflag) {
    wholeVar4Page.showOrHide = showOrHide;
...
$(function () {
    ...
    var ztArr = [{'id': '1', 'text': '全部'}, {'id': '2', 'text': '待登记'}, {'id': '3', 'text': '已登记'}, {
        'id': '4',
        'text': '待回访'
    }, {'id': '5', 'text': '已回访'}]
